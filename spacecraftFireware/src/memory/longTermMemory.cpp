...
longTermMemory::longTermMemory() : memory(MEMORY_SIZE, 0) {}

bool longTermMemory::write(size_t offset, const void* data, size_t size) {
...
size_t longTermMemory::read(size_t offset, void* buffer, size_t size) const {
